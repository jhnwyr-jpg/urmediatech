  ...
  const projects = [
    {
      ...
      categoryKey: "portfolio.saasCategory",
    ...
    {
      id: 2,
      titleKey: "portfolio.masala",
      categoryKey: "portfolio.masalaCategory",
      descriptionKey: "portfolio.masalaDesc",
      demoUrl: "https://masalapage.netlify.app/",
      gradient: "from-orange-500 to-red-500",
    },
    {
      id: 3,
      titleKey: "portfolio.khejur",
      categoryKey: "portfolio.khejurCategory",
      descriptionKey: "portfolio.khejurDesc",
      demoUrl: "https://khgejurgur.netlify.app/",
      gradient: "from-amber-500 to-orange-500",
    },
    {
      id: 4,
      titleKey: "portfolio.tshirt",
      categoryKey: "portfolio.tshirtCategory",
      descriptionKey: "portfolio.tshirtDesc",
