...
const translations = {
  bn: {
    ...
    "testimonials.name3": "এমিলি রবার্টস",
    ...
    "footer.copyright": "© ২০২৪ ইউআর মিডিয়া। সর্বস্বত্ব সংরক্ষিত।",
  ...
  en: {
    ...
    "testimonials.name3": "Emily Roberts",
    ...
    "footer.copyright": "© 2024 UR Media. All rights reserved.",
