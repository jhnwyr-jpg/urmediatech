...
const translations = {
  bn: {
    ...
    "contact.phonePlaceholder": "আপনার ফোন নম্বর লিখুন",
    ...
    "pricing.starterF3": "Next.js দিয়ে ফুল কোডেড ওয়েবসাইট",
    "pricing.starterF4": "ফুল ফাংশনাল অ্যাডমিন প্যানেল",
    "pricing.premiumName": "প্রিমিয়াম প্যাকেজ",
    "pricing.premiumF1": "ফ্রি .com ডোমেইন",
    "pricing.premiumF2": "ফ্রি প্রিমিয়াম হোস্টিং",
    "pricing.premiumF3": "Next.js দিয়ে ফুল কোডেড ওয়েবসাইট",
    "pricing.premiumF4": "ফুল ফাংশনাল অ্যাডমিন প্যানেল",
    "pricing.premiumF5": "২৪ ঘণ্টা প্রাইওরিটি সাপোর্ট",
    "pricing.premiumF6": "SEO বেসিক সেটআপ",
    "pricing.businessName": "বিজনেস প্যাকেজ",
    "pricing.businessBadge": "⭐ বেস্ট ভ্যালু",
    "pricing.businessF1": "প্রিমিয়াম কাস্টম ডিজাইন (ইউনিক লুক)",
    "pricing.businessF2": "ওয়েবসাইট স্পিড অপ্টিমাইজেশন",
    "pricing.businessF3": "অ্যাডভান্স SEO সেটআপ",
    "pricing.businessF4": "২৪/৭ প্রাইওরিটি সাপোর্ট",
    "pricing.businessF5": "আনলিমিটেড রিভিশন",
    "pricing.businessF6": "মাসিক ফ্রি মেইনটেনেন্স",
    "pricing.businessF7": "সিকিউরিটি + ব্যাকআপ সিস্টেম",
    "pricing.businessF8": "অতিরিক্ত পেজ / ল্যান্ডিং পেজ",
    "pricing.businessF9": "পেমেন্ট গেটওয়ে / অটোমেশন সেটআপ",
    "pricing.businessF10": "প্রিমিয়াম হোস্টিং সাজেশন / সেটআপ",
    "pricing.orderBtn": "অর্ডার করুন",
    "pricing.note": "* সব প্যাকেজে SSL সার্টিফিকেট এবং মোবাইল রেসপন্সিভ ডিজাইন ইনক্লুডেড।",

    // Booking
    "booking.label": "মিটিং বুক করুন",
    "booking.title": "আমাদের সাথে",
    "booking.titleHighlight": "মিটিং বুক করুন",
    "booking.subtitle": "আপনার প্রজেক্ট নিয়ে আলোচনা করতে একটি ফ্রি ডিসকভারি কল বুক করুন।",
    "booking.callTitle": "ডিসকভারি কল",
    "booking.minutes": "মিনিট",
    "booking.selectDate": "তারিখ সিলেক্ট করুন",
    "booking.selectTime": "সময় সিলেক্ট করুন",
    "booking.pickDateFirst": "প্রথমে একটি তারিখ সিলেক্ট করুন",
    "booking.next": "পরবর্তী",
    "booking.back": "আগের ধাপে যান",
    "booking.nameLabel": "আপনার নাম",
    "booking.namePlaceholder": "আপনার নাম লিখুন",
    "booking.phoneLabel": "ফোন নম্বর",
    "booking.phonePlaceholder": "আপনার ফোন নম্বর",
    "booking.emailLabel": "ইমেইল (ঐচ্ছিক)",
    "booking.emailPlaceholder": "আপনার ইমেইল",
    "booking.confirm": "মিটিং কনফার্ম করুন",
    "booking.submitting": "বুক হচ্ছে...",
    "booking.successTitle": "মিটিং বুক হয়েছে!",
    "booking.successDesc": "আমরা শীঘ্রই আপনার সাথে যোগাযোগ করব।",
    "booking.errorTitle": "ত্রুটি",
    "booking.errorDesc": "মিটিং বুক করতে ব্যর্থ। আবার চেষ্টা করুন।",
    "booking.confirmedTitle": "মিটিং বুক হয়ে গেছে! ✅",
    "booking.confirmedDesc": "আমরা আপনার সাথে যোগাযোগ করব কনফার্মেশনের জন্য।",
  ...
  en: {
    ...
    "pricing.starterF3": "Full Coded Website with Next.js",
    ...
    "pricing.premiumF3": "Full Coded Website with Next.js",
    "pricing.premiumF4": "Fully Functional Admin Panel",
    "pricing.premiumF5": "24-Hour Priority Support",
    "pricing.premiumF6": "Basic SEO Setup",
    "pricing.businessName": "Business Package",
    "pricing.businessBadge": "⭐ Best Value",
    "pricing.businessF1": "Premium Custom Design (Unique Look)",
    "pricing.businessF2": "Website Speed Optimization",
    "pricing.businessF3": "Advanced SEO Setup",
    "pricing.businessF4": "24/7 Priority Support",
    "pricing.businessF5": "Unlimited Revisions",
    "pricing.businessF6": "Monthly Free Maintenance",
    "pricing.businessF7": "Security + Backup System",
    "pricing.businessF8": "Extra Pages / Landing Pages",
    "pricing.businessF9": "Payment Gateway / Automation Setup",
    "pricing.businessF10": "Premium Hosting Suggestion / Setup",
    "pricing.orderBtn": "Order Now",
    "pricing.note": "* All packages include SSL certificate and mobile-responsive design.",

    // Booking
    "booking.label": "Book a Meeting",
    "booking.title": "Schedule a",
    "booking.titleHighlight": "Discovery Call",
    "booking.subtitle": "Book a free discovery call to discuss your project with our team.",
    "booking.callTitle": "Discovery Call",
    "booking.minutes": "min",
    ...
    "booking.emailLabel": "Email (optional)",
    "booking.emailPlaceholder": "Your email",
    "booking.confirm": "Confirm Meeting",
    "booking.submitting": "Booking...",
    "booking.successTitle": "Meeting Booked!",
    "booking.successDesc": "We'll contact you shortly to confirm.",
    "booking.errorTitle": "Error",
    "booking.errorDesc": "Failed to book meeting. Please try again.",
    "booking.confirmedTitle": "Meeting Booked! ✅",
    "booking.confirmedDesc": "We'll reach out to confirm your meeting.",
